...
| **Post-N, lr3e-4 constant** | **лучше** | **лучше** | **шум** | G лучше; fix M inference ✅ pending validation |
...
### Следующий шаг (fix M validation)

Fix M **реализован** — см. `10-fix-m-validation.md`. Re-sample ep4/ep5 через standalone sampler с `source_job_id` (**без retrain**).

**Критерий успеха:** ep4–10 без шума при aligned conditioning.
