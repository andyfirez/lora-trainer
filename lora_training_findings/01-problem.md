...
1. **Effective LR ~20× ниже Kohya** (alpha/rank × lr) — гипотеза G
2. **Square crop без bucketing** — гипотеза C
3. **Неверные add_time_ids при train** (original_size, crop coords) — гипотезы H/I
4. **fp16 + AdamW8bit** vs bf16 + AdamW — гипотезы J/K
