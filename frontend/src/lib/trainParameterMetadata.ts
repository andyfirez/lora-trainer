...
export const TRAIN_PARAMETER_METADATA: ParameterMeta[] = [
  ...
  {
    key: "sample_sampler_name",
    label: "Sample Sampler",
    section: "Sampling",
    shortHint: "Comfy-compatible sampler algorithm for preview generation.",
    description:
      "Sampler algorithm for post-train sampling jobs. Resolved from the linked sampling config in normal workflows.",
    defaultValue: "euler",
    constraints: "euler | euler_ancestral | dpmpp_2m",
    yamlOnly: true,
    recommendedValue: "euler",
    valueOptions: [
      { value: "euler", description: "Euler; first V1 slice and default SDXL workflow." },
      { value: "euler_ancestral", description: "Euler ancestral; adds per-step noise." },
      { value: "dpmpp_2m", description: "DPM++ 2M multistep solver." },
    ],
  },
  {
    key: "sample_scheduler",
    label: "Sample Sigma Scheduler",
    section: "Sampling",
    shortHint: "Comfy-compatible sigma schedule for preview generation.",
    description:
      "Sigma schedule name paired with the sampler algorithm. simple and karras are supported in V1.",
    defaultValue: "simple",
    constraints: "simple | karras",
    yamlOnly: true,
    recommendedValue: "simple",
    valueOptions: [
      { value: "simple", description: "Comfy simple scheduler; pairs with euler and euler_ancestral." },
      { value: "karras", description: "Karras sigma ramp; pairs with dpmpp_2m." },
    ],
  },
  {
